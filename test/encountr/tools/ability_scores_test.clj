(ns encountr.tools.ability-scores-test
  (:require [clojure.test :refer :all]
            [encountr.tools.ability-scores :as ability-scores]))

(deftest ability-modifier-test
  (testing "ability modifiers are calculated correctly"
    (is (every?
         (fn [[score modifier]] (= modifier (ability-scores/ability-modifier score)))
